...
Hi {}, my name is {}! I'm a modular group management bot created and maintained by the Admin panel of [Movie Matrix](https://t.me/moviematrix2):- [Akash](tg://user?id=710570461) and[ᴄʀᴇᴀᴛoʀ](tg://user?id=922303277) 
...
DONATE_STRING = """[Akash](tg://user?id=710570461), [ᴄʀᴇᴀᴛoʀ](tg://user?id=922303277)."""
        ...
        if len(args) >= 1:
            ...
            update.effective_message.reply_text(
                ...
                parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(
                    [[InlineKeyboardButton(text="✅ Join Our Group", url="https://t.me/moviematrix2")],
                     [InlineKeyboardButton(text="🔔 Official Channel", url="https://t.me/moviematrix20")],
                     [InlineKeyboardButton(text="📁 Archive Channel", url="https://t.me/moviematrixarchive")], 
